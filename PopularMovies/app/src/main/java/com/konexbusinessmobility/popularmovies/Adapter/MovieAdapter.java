...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    private final MovieAdapterOnClickListener mAdapterOnClickListener;
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            int clickPosition = movieViewHolder.getAdapterPosition();
            Intent intent = new Intent(mContext, MovieDetailActivity.class);
            intent.putExtra(MovieDetailActivity.EXTRA_MOVIE, movies.get(clickPosition));
            mContext.startActivity(intent);
            movieAdapterOnClickListener.onItemClick(clickPosition);
